...
$messages['policyduplicatechars'] = "Nombre maximum de répétition autorisées";
$messages['duplicatechars'] = "Votre mot de passe contient plus de répétition qu'autorisée";
$messages['policyfirstchar'] = "Le premier caractère de votre mot de passe doit être alphanumérique";
$messages['firstcharnonalpha'] = "Le premier caractère de votre mot de passe n'est pas alphanumérique";
$messages['policynumericsequence'] = "Votre mot de passe ne doit pas contenir de suite de nombre (123, 234, ...)";
$messages['numericsequence'] = "Votre mot de passe contient une suite de nombre (123, 234, ...)";
